...
import os
import sys
path = 'X:/Shared drives/Pipeline/tools/OctoTools/core/scripts/python/OctoBrowser'
sys.path.append(r'C:\Users\danger\AppData\Local\Programs\Python\Python37\Lib\site-packages')
